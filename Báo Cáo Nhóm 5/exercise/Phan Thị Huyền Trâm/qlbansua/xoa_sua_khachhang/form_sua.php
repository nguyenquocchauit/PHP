        ...
        <form action="xuly_sua.php" method="post">
            <table>
                ...
                <?php while ($row = mysqli_fetch_array($result)) :   ?>
                    ...
                    <tr>
                        <td>Mã khách hàng</td>
                        <td><input type='input' name='idkh' value ='$IDKH' readonly></td>
                    </tr>
                    <tr>
                        <td>Tên khách hàng</td>
                        <td><input type='input' name='name' value ='$Name'></td>
                    </tr>
                    <tr>
                        <td>Giới tính : </td>
                        <td>
                            <input type='input' name='gender' value ='$Gender'>
                        </td>
                    </tr>
                    <tr>
                        <td>Địa Chỉ</td>
                        <td><input type='input' name='add' value ='$Address'></td>
                    </tr>
                    <tr>
                        <td>Điện thoại</td>
                        <td><input type='input' name='phone' value ='$Phone'></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td><input type='input' name='email' value =' $Email'></td>
                    </tr>
                    ";
                    ?>
                <?php endwhile; ?>
