...
if (isset($_POST['username']) && isset($_POST['password'])) {
    ...
    if (str_contains($_username, '@') && str_contains($_username, '.') && !(str_contains($_username, " "))) {
        $sqlUserName = "SELECT * FROM customers WHERE Email='" . $_username . "'";
        ...
        if (!(str_contains($_username, " "))) {
            ...
            $sqlUserName = "SELECT * FROM customers WHERE UserName='" . $_username . "'";
            $result = mysqli_query($conn, $sqlUserName);
