...
session_start();
// kết nối cơ sở dữ liệu db_watch
require '../../Website Watch PHP/config/connectDB.php';
// nếu get gender,id,brand không có thì không truy cập được trang, sẽ quay về shop.php
if (isset($_GET["gender"]) == false && isset($_GET["gender"]) == false && isset($_GET["gender"]) == false) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="mt-5">
                                ...
                                <table>
                                    <tr>
                                        <td><img class="imgpay" src="../../Website Watch PHP/img/logo-techcombank.jpg" alt=""></td>
                                        <td><img class="imgpay" src="../../Website Watch PHP/img/logo-paypal.jpg" alt="" srcset=""></td>
                                        <td><img class="imgpay" src="../../Website Watch PHP/img/logo-techcombank.jpg" alt="" srcset=""></td>
                                    </tr>
                                    <tr>
                                        <td><img class="imgpay" src="../../Website Watch PHP/img/logo-vcb.jpg" alt=""></td>
                                        <td><img class="imgpay" src="../../Website Watch PHP/img/logo-techcombank.jpg" alt="" srcset=""></td>
                                        <td><img class="imgpay" src="../../Website Watch PHP/img/logo-mastercard.jpg" alt=""></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
